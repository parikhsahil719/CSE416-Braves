    ...
    <span className="sidebar-wrapper">
      ...
      <nav className="sidebar">
        ...
        <span className="sidebar-analysis-container">
          ...
          <div className={currPolarization === "EI KDE" ? "polarization-option activeTab" : "polarization-option"} onClick={() => { switchPolarization('EI KDE'); switchPage('Polarization'); navigate(`/state/${stateName}/Ecological Inference`) }}>EI KDE</div>
