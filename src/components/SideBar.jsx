    ...
    <span className="sidebar-wrapper">
      ...
      <nav className="sidebar">
        ...
        <span className="sidebar-analysis-container">
          ...
          <div className={currSimData === "Minority Representation" ? "sim-option activeTab" : "sim-option"} onClick={() => { switchSimData('Minority Representation'); switchPage('Simulation Data'); navigate(`/state/${stateName}/Simulation Data`) }}>Minority Representation</div>
